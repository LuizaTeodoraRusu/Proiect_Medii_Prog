...
namespace RESTAURANT.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            var rESTAURANTContext = _context.Reservation.Include(r => r.Location);
        ...
        public async Task<IActionResult> Create([Bind("ReservationId,LocationId,DateAndTime")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservationId,LocationId,DateAndTime")] Reservation reservation)
        {
